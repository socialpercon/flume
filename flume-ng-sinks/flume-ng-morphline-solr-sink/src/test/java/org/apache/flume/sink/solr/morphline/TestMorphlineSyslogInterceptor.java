...
public class TestMorphlineSyslogInterceptor extends Assert {
	...
	private static final String RESOURCES_DIR = "target/test-classes";
	  ...
	  public void testGrokIfNotMatchDropEventRetain() throws Exception {
	    ...
	    context.put(MorphlineHandlerImpl.MORPHLINE_FILE_PARAM, RESOURCES_DIR + "/test-morphlines/grokSyslog.conf");
